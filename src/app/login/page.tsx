    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight">Futapp</h1>
        ...
        <div className="bg-card rounded-2xl border shadow-sm p-6 sm:p-8">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Accede con tu cuenta de Google para entrar a la app.
          </p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          ¿No tienes acceso? Pide al administrador del equipo un link de invitación.
        </p>
      </div>
    </div>
  )
